...
const ConfirmationOfNewTrip: React.FC<ConfirmationOfNewTripProps> = ({ showModal, handleOpenModal, handleCloseModal, sAddress, fAddress }) => {
    ...
    const newTripConfirmation = async () => {
        const response = await NewTripService.createNewTrip(sAddress, fAddress, priceOfTheTrip, timeForTheTaxiToArrive, durationOfTheTrip);

        console.log(response);
    }

    const cancelingNewTrip = async () => {
        alert('Odustali ste od vožnje!');
        handleCloseModal();
    }
